...
android {
    ...
    signingConfigs {
        create("release") {
            keyAlias = Config.SigningConfigs.Release.keyAlias
            keyPassword = Config.SigningConfigs.Release.keyPassword
            storeFile = file(Config.SigningConfigs.Release.storeFile)
            storePassword = Config.SigningConfigs.Release.storePassword
        }
    }
